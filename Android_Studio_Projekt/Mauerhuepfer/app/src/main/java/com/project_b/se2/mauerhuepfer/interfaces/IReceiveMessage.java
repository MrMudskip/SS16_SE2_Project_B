...
public interface IReceiveMessage {
    ...
    @IntDef({USAGE_GAME_INITIALISED, USAGE_CLICKEDPLAYER, USAGE_CLICKEDBLOCK, USAGE_PLAYERID, USAGE_DICE_SELECTED, USAGE_DICE_ROLLED, USAGE_FIGUREMOVED, USAGE_NEXTPLAYER, USAGE_STARTGAME, USAGE_MSG, USAGE_JOIN, USAGE_RESTART, USAGE_CHEATED, USAGE_REMOVE_FIGURE})
