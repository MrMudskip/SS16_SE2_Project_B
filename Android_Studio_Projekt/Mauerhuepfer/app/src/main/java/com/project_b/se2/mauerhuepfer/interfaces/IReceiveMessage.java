...
public interface IReceiveMessage {
    ...
    @IntDef({USAGE_GAMEBOARDCREATED, USAGE_PLAYERID, USAGE_DICE, USAGE_FIGURESELECTED, USAGE_FIGUREMOVED, USAGE_NEXTPLAYER, USAGE_STARTGAME, USAGE_MSG, USAGE_JOIN, USAGE_RESTART})
    @interface UpdateUsageCode {
    }

    int USAGE_GAMEBOARDCREATED = 1027;
